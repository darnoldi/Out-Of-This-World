...
@interface DASpaceDataViewController ()

@end

@implementation DASpaceDataViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        ...
        case 6:
            ...
            cell.detailTextLabel.text = [NSString stringWithFormat:@"%i", self.spaceObject.nomberOfMoons ];
            break;
